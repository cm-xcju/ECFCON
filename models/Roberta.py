...
from transformers import BertModel,AutoModelForMaskedLM,AutoTokenizer,AutoModelForSequenceClassification
import warnings
...
class myRoberta(nn.Module):
    def __init__(self, opt,emo2idx,cos2idx) -> None:
        ...
        self.bert = AutoModelForSequenceClassification.from_pretrained(opt.bert_path)
    ...
    def get_pooler_output(self,input_ids,attention_mask,token_type_ids):
        ...
        outputs = self.bert(input_ids=dense_input_ids,token_type_ids=dense_token_type_ids,attention_mask=dense_attention_mask,output_hidden_states=True)
